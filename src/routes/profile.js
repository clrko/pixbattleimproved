...
router.get('/', checkToken, (req, res, next) => {
  const sqlUserInfos = `SELECT COUNT(winner_user_id) AS victories
    FROM user AS u
...
router.get('/my-ranking', checkToken, (req, res, next) => {
...
router.get('/avatars', checkToken, (req, res, next) => {
...
router.put('/settings/informations', checkToken, (req, res, next) => {
  const userId = req.user.userId;
